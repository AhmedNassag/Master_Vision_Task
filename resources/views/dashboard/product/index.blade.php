                                            ...
                                            <table id="example1" class="table table-stripped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center notPrint">
                                                            @if($item->media)
                                                                <img class="mb-1" src="{{ $item->media->file_path }}" alt="{{ $item->media->file_name }}" height="70" width="100">
                                                                <br>
                                                                <a class="btn btn-outline-success btn-sm" href="{{ $item->media->file_path }}" role="button" target="_blank"><i class="fas fa-eye"></i></a>
                                                                <!-- <a class="btn btn-outline-success btn-sm" href="{{ url('show_file') }}/product/{{ $item->media->file_name }}" role="button"><i class="fas fa-eye"></i></a> -->
                                                                <!-- <a class="btn btn-outline-info btn-sm" href="{{ url('download_file') }}/product/{{ $item->media->file_name }}" role="button"><i class="fas fa-download"></i></a> -->
                                                            @endif
                                                        </td>
