                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">{{ trans('main.ShopProducts') }}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ trans('main.Dashboard') }}</a></li>
                                    <li class="breadcrumb-item active">{{ trans('main.ShopProducts') }}</li>
                                </ul>
                            </div>
                            <div class="col-auto">
                                ...
                                <a href="{{ route('shopProduct.create') }}" role="button" class="btn add-button me-2">
                                    <i class="fas fa-plus"></i>
                                </a>
                    ...
                    <!-- Search Filter -->
                    <div class="card filter-card" id="filter_inputs" @if($shop_id || $product_id || $from_date || $to_date) style="display:block" @endif>
                        <div class="card-body pb-0">
                            <form action="{{ route('shopProduct.index') }}" method="get">
                                <div class="row filter-row">
                                    <!-- shop_id -->
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('main.Shop') }} :</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- canNotUpdated Notify -->
                                    @if (session()->has('canNotUpdated'))
                                    <script id="canNotUpdated">
                                        window.onload = function() {
                                            notif({
                                                msg: "لا يمكن التعديل لوجود كمية لهذا المنتج تخص هذا المتجر برجاء التعديل عليها..!",
                                                type: "error"
                                            })
                                        }
                                    </script>
                                            ...
                                            <table id="example1" class="table table-stripped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">{{ trans('main.Shop') }}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $item->shop ? $item->shop->name : '' }}</td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ route('shopProduct.show', $item->id) }}" role="button" class="btn btn-sm btn-info" title="{{ trans('main.Show') }}"><i class="far fa-eye"></i></a>
                                                        </td>
                                                    </tr>
                                                    @include('dashboard.shopProduct.editModal')
                                                    @include('dashboard.shopProduct.deleteModal')
                                                    @endforeach
                                                    @else
                                                    <tr>
                        ...
                        @include('dashboard.shopProduct.addModal')
                        @include('dashboard.shopProduct.deleteSelectedModal')		
                    </div>	
                </div>
            </div>			
        </div>
