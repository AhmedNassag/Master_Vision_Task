                ...
                <div class="content container-fluid">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">{{ trans('main.Shops') }}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ trans('main.Dashboard') }}</a></li>
                                    <li class="breadcrumb-item active">{{ trans('main.Shops') }}</li>
                                </ul>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ route('shop.show', $item->id) }}" role="button" class="btn btn-sm btn-info" title="{{ trans('main.Show') }}"><i class="far fa-eye"></i></a>
                                                        </td>
                                                    </tr>
                                                    @include('dashboard.shop.editModal')
                                                    @include('dashboard.shop.deleteModal')
                                                    @endforeach
                                                    @else
                                                    <tr>
                        ...
                        @include('dashboard.shop.addModal')
                        @include('dashboard.shop.deleteSelectedModal')		
                    </div>	
                </div>
            </div>			
        </div>
